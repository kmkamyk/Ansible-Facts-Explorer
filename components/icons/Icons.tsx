...
export const ExcelIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
    <path fillRule="evenodd" d="M3 3a1 1 0 011-1h12a1 1 0 011 1v3H3V3zM3 7h14v10a1 1 0 01-1 1H4a1 1 0 01-1-1V7zm2-2h2v2H5V5zm4 0h2v2H9V5zm4 0h2v2h-2V5zm-8 4h2v2H5V9zm4 0h2v2H9V9zm4 0h2v2h-2V9zm-8 4h2v2H5v-2zm4 0h2v2H9v-2z" clipRule="evenodd" />
  </svg>
);
...
export const ColumnsIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
    <path d="M5 3a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 5h3v10H5V5zm4 0h6v10h-6V5z" />
  </svg>
);
...
export const XSmallIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
...
export const ExpandIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
    <path fillRule="evenodd" d="M3 3a1 1 0 00-1 1v5h2V5h4V3H4a1 1 0 00-1-1zm0 8H1v5a1 1 0 001 1h5v-2H5v-4zm8-8h5a1 1 0 011 1v5h-2V5h-4V3zm4 8h2v5a1 1 0 01-1 1h-5v-2h4v-4z" clipRule="evenodd" />
  </svg>
);

export const CompressIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
    <path fillRule="evenodd" d="M5 5a1 1 0 00-1 1v3h2V7h3V5H5zM5 14v-3H3v4a1 1 0 001 1h4v-2H5zm10-9h-4v2h3v3h2V6a1 1 0 00-1-1zm-1 9h-3v2h4a1 1 0 001-1v-4h-2v3z" clipRule="evenodd" />
  </svg>
);
...
export const HardDriveIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 20 20" fill="currentColor">
        <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-2 0c0 .993-.241 1.929-.668 2.754l-1.524-1.525a3.996 3.996 0 000-2.456l1.524-1.525C15.76 8.071 16 8.997 16 10zM4 10c0-.993.241-1.929.668-2.754l1.524 1.525a3.996 3.996 0 000 2.456l-1.524 1.525C4.24 11.929 4 11.003 4 10zm4.5 0a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" clipRule="evenodd" />
    </svg>
);

export const ChipIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 20 20" fill="currentColor">
        <path fillRule="evenodd" d="M14 3a1 1 0 011 1v12a1 1 0 01-1 1H6a1 1 0 01-1-1V4a1 1 0 011-1h8zM6 2a2 2 0 00-2 2v12a2 2 0 002 2h8a2 2 0 002-2V4a2 2 0 00-2-2H6z" clipRule="evenodd" />
